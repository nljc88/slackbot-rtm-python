...
outputs = []
crontable = []
crontable.append([42600, "cah_lookup"])

FILE="plugins/comics/cah_count"
...
def make_url(arg):
	base_url = 'http://explosm.net/comics/%s/'
	url = base_url % arg
	return url
...
def cah_lookup():
	...
	if response == 200:
		...
		outputs.append(['<CHANNEL ID>', 'no new Cyanide and Happiness comic at this time, will check again in 12hrs'])
